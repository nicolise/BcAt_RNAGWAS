...
HEM.plotdata.og <- read.csv("data/BcBOT_MAF05_HEM.PlotFormat.csv")
...
HEM.topSNPs <- rbind(HEM.Bcin12g06380.1.coi.1.HEM, HEM.Bcin12g06430.1.coi.1.HEM, HEM.Bcin12g06410.1.coi.1.HEM, HEM.Bcin12g06400.1.coi.1.HEM, HEM.Bcin12g06390.1.coi.1.HEM, HEM.Bcin12g06420.1.coi.1.HEM, HEM.Bcin12g06370.1.coi.1.HEM, HEM.Bcin12g06380.1.col.0.HEM, HEM.Bcin12g06430.1.col.0.HEM, HEM.Bcin12g06410.1.col.0.HEM, HEM.Bcin12g06400.1.col.0.HEM)

#total sig SNPs per trait here
table(HEM.topSNPs$Trait)

jpeg(paste("plots/BOT_NA10_lowTR_MAF05.ManhattanPlot.jpg", sep=""), width=7.5, height=5, units='in', res=600)
