...
for (j in c("col0")){
  for (i in 1:9267){
    ...
    try(ifelse( i == 1, write.table(my_gemma_top100, paste("06_GEMMAsumm_RAND/",j,"_GEMMA_top100SNPsample.txt"), sep = ",", col.names = TRUE), write.table(my_gemma_top100, paste("06_GEMMAsumm_RAND/",j,"_GEMMA_top100SNPsample.txt"), sep = ",", col.names = FALSE, append = TRUE)))
    try(ifelse( i == 1, write.table(my_gemma_top10, paste("06_GEMMAsumm_RAND/",j,"_GEMMA_top10SNPsample.txt"), sep = ",", col.names = TRUE), write.table(my_gemma_top10, paste("06_GEMMAsumm_RAND/",j,"_GEMMA_top10SNPsample.txt"), sep = ",", col.names = FALSE, append = TRUE)))
    try(ifelse( i == 1, write.table(my_gemma_top1, paste("06_GEMMAsumm_RAND/",j,"_GEMMA_top1SNPsample.txt"), sep = ",", col.names = TRUE), write.table(my_gemma_top1, paste("06_GEMMAsumm_RAND/",j,"_GEMMA_top1SNPsample.txt"), sep = ",", col.names = FALSE, append = TRUE)))
    try(ifelse( i == 1, write.table(my_gemma.z, paste("06_GEMMAsumm_RAND/",j,"_GEMMA_topSNPsample_zscale.txt"), sep = ",", col.names = TRUE), write.table(my_gemma.z, paste("06_GEMMAsumm_RAND/",j,"_GEMMA_topSNPsample_zscale.txt"), sep = ",", col.names = FALSE, append = TRUE)))
    try(ifelse( i == 1, write.table(mylgsnp, paste("06_GEMMAsumm_RAND/",j,"_GEMMA_top100_beta05SNP.txt"), sep = ",", col.names = TRUE), write.table(mylgsnp, paste("06_GEMMAsumm_RAND/",j,"_GEMMA_topSNP_beta05.txt"), sep = ",", col.names = FALSE, append = TRUE)))
    Sys.time()
  }
}
mytime
