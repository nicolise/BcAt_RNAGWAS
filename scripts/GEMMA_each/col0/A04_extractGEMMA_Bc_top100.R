...
##fixed the dumb typo!!
    try(ifelse( i == 1, write.table(my_gemma_top100, paste("06_GEMMAsumm/",j,"_GEMMA_top100SNPsample.txt"), sep = ",", col.names = TRUE), write.table(my_gemma_top100, paste("06_GEMMAsumm/",j,"_GEMMA_top100SNPsample.txt"), sep = ",", col.names = FALSE, append = TRUE)))
