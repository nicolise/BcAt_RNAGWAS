...
#4. RUN ./plink --noweb --file E_01_PLINK/dpbinMAF20NA10 --maf 0.2 --make-bed --out binMAF20NA10 } do this ONCE. NEXT STEP is customized by ogphenos/ permutation
...
myFAM <- read.table("B05_GEMMA_les/E_01_PLINK/binMAF20NA10.fam")
...
#remove 1.02.13, 94.4
#check these numbers
Phenos_match <- Phenos_match[c(2:13,15:97),]
...
setwd("~/Documents/GitRepos/BcAt_RNAGWAS/data")
write.csv(myFAM_match2, "B05_GEMMA_les/E_02_GEMMA/binMAF20NA10_fam.csv")
write.table(myFAM_match2, "B05_GEMMA_les/E_02_GEMMA/binMAF20NA10.fam", row.names=FALSE, col.names=TRUE)
