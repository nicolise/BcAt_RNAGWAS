#Nicole E Soltis
#09/22/17
#convert .tab data to binary .csv for BOT
#02_PrepGenos.R
#---------------------------------------------------
rm(list=ls())
#on linux desktop
...
tab5 = read.delim("00_tabfiles/Suzi_033016/Haploid_SNPS_97_dp6_maf5.tab")
write.table(tab5, file="01_Genos/snps_maf5.csv",sep=",",col.names=T,row.names=FALSE)
tab10 = read.delim("00_tabfiles/Suzi_033016/Haploid_SNPS_97_iso_dp6_maf10.tab")
write.table(tab10, file="01_Genos/snps_maf10.csv",sep=",",col.names=T,row.names=FALSE)
tab20 = read.delim("00_tabfiles/Suzi_033016/Haploid_SNPS_97_dp6_maf20.tab")
write.table(tab20, file="01_Genos/snps_maf20.csv",sep=",",col.names=T,row.names=FALSE)


#convert each file to binary
SNPsMAF5 <- read.csv("01_Genos/snps_maf5.csv")
SNPsMAF10 <- read.csv("01_Genos/snps_maf10.csv")
SNPsMAF20 <- read.csv("01_Genos/snps_maf20.csv")
mySNPs <- SNPsMAF5
#code "." as NAs
...
#write.csv(allSNPs, "01_Genos/hp_charMAF05.csv")
write.csv(mySNPs, "02_MatchGenos/hp_binMAF05_20NA.csv")
