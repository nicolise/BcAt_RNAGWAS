...
#Get genotype data
SNPs <- read.csv("03_bigRR/BOT_genos_MAF10.csv", row.names = 1)
FullSNPs <- SNPs
SNPs <- FullSNPs
...
Phenos <- read.csv("03_bigRR/BOT_phenos_MAF10.csv", row.names = 1)
...
con <- file("04_bigRRouts/Allphenos_MAF10_092917.log")
...
write.csv(outpt.HEM,"04_bigRRouts/bigRR_MAF10_092917.HEM.csv")