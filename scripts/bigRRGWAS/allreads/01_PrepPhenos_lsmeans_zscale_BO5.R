...
#write out file
write.csv(full.lsm.outputs, "allreadsGWAS/BO5.10/01_prepFiles/ANOVA_lsmoutputs_allreads.csv")
write.csv(lsm.for.GWAS, "allreadsGWAS/BO5.10/01_prepFiles/lsmeans_allreads.csv")
write.csv(my.lsm.z, "allreadsGWAS/BO5.10/01_prepFiles/lsmeans_zscale_allreads.csv")
