...
Phenos <- read.csv("allreadsGWAS/01_prepFiles/lsmeans_allreads.csv")
Phenos <- Phenos[,-c(1)]
...
#save them files!
write.csv(matchedSNPs2, "allreadsGWAS/02_bigRR/lsmeans_allreads_SNPS_MAF20.csv")
write.csv(matchedPhenos2, "allreadsGWAS/02_bigRR/lsmeans_allreads_phenos_MAF20.csv")
