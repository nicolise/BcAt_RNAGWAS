...
#Get genotype data
SNPs <- read.csv("data/testMethods/BO5tomato/02_bigRR/tomato_SNPS_MAF20.csv", row.names = 1)
FullSNPs <- SNPs
SNPs <- FullSNPs
...
Phenos <- read.csv("data/testMethods/BO5tomato/02_bigRR/tomato_phenos_MAF20.csv", row.names = 1)
...
con <- file("data/testMethods/BO5tomato/03_bigRRout/tomato_BO510_bigRR.log")
...
write.csv(rbind(thresh.HEM$"pos0.95Thresh",thresh.HEM$"pos0.975Thresh",thresh.HEM$"pos0.99Thresh",thresh.HEM$"pos0.999Thresh",thresh.HEM$"neg0.95Thresh",thresh.HEM$"neg0.975Thresh",thresh.HEM$"neg0.99Thresh",thresh.HEM$"neg0.999Thresh",outpt.HEM),"data/testMethods/BO5tomato/03_bigRRout/tomato_BO510_bigRR.csv")
