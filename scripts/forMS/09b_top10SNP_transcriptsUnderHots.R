...
AtDat <- read.csv("data/GEMMA_eachBc_At/05_GEMMAsumm/GeneNames/SNPannot/col0_GEMMA_top10SNPsample_genes.csv")
...
setwd("~/Projects/BcAt_RNAGWAS")
write.csv(BcDat_summ, "data/GEMMA_eachAt_Bc/07_TopSNPs/BcAt_permut/top10SNP/Bc_genesUnderSigHotspots.csv")
write.csv(AtDat_summ, "data/GEMMA_eachAt_Bc/07_TopSNPs/BcAt_permut/top10SNP/At_genesUnderSigHotspots.csv")
...
write.csv(Bc.gene.hiherit, "GEMMA_eachAt_Bc/07_TopSNPs/BcAt_permut/top10SNP/SDS5_Bc_HotSpots.csv")
#LesCor
...
write.csv(Bc.gene.lescor, "GEMMA_eachAt_Bc/07_TopSNPs/BcAt_permut/top10SNP/SDS6_Bc_HotSpots.csv")
#BcNets
...
write.csv(Bc.gene.bcnets, "GEMMA_eachAt_Bc/07_TopSNPs/BcAt_permut/top10SNP/SDS7_Bc_HotSpots.csv")
bcnets.summ <- Bc.gene.bcnets
bcnets.summ$groupCol0 <- paste(bcnets.summ$HotSpotNearestGene, bcnets.summ$Identification_Col0, sep="_")
bcnets.summ$groupcoi1 <- paste(bcnets.summ$HotSpotNearestGene, bcnets.summ$Identification_coi1, sep="_")
bcnets.summ$groupnpr1 <- paste(bcnets.summ$HotSpotNearestGene, bcnets.summ$Identification_npr1, sep="_")
blah <- as.data.frame(table(bcnets.summ$groupCol0))
blah <- as.data.frame(table(bcnets.summ$groupcoi1))
blah <- as.data.frame(table(bcnets.summ$groupnpr1))
